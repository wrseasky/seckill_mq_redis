...
public class CodeMsg {
    ...
    public static CodeMsg SESSION_ERROR = new CodeMsg(500202, "用户名或者密码错误");
    public static CodeMsg SECKill_OVER = new CodeMsg(500202, "用户名或者密码错误");
    public static CodeMsg REPEATE_SECKILL = new CodeMsg(500202, "用户名或者密码错误");
